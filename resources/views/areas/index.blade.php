    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <p class="mb-sm-0">Listado De Areas</p>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <a href="{{ route('areas.create') }}" class="btn btn-sm btn-primary">Nuevo Registro</a>
              <button class="btn btn-sm btn-success" id="btnRefresh"><i class="ri-refresh-line"></i> Recargar</button>
            </div>
            <div class="table-responsive">
              <table id="areas-table" class="table table-bordered table-striped" style="width:100%">
                <thead>
                  <tr>
                    <th>Nombre</th>
                    <th>Departamento</th>
      ...
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            let editUrl = `{{ url("areas") }}/${row.id}/edit`;
            return `

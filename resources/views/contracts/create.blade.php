    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <p class="mb-sm-0">Nuevo Registro de Contrato</p>
              ...
              @csrf
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select id="provider_id" name="provider_id" class="form-select" required></select>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6 mb-3">
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    <label for="renewal_notice_days" class="form-label">Avisar días antes <span class="text-danger">*</span></label>
                    <input type="number" name="renewal_notice_days" id="renewal_notice_days" class="form-control" value="{{ old('renewal_notice_days') }}" required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <select name="auto_renew" id="auto_renew" class="form-select" required>
                      ...
                      <option value="1" {{ old('auto_renew') == '1' ? 'selected' : '' }}>Sí</option>
                      <option value="0" {{ old('auto_renew') == '0' ? 'selected' : '' }}>No</option>
                    </select>
                    @error('auto_renew')
                      <span class="text-danger small">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-3">
                  <label for="messaging_enabled" class="form-label">¿Mensajería habilitada para este contrato? <span class="text-danger">*</span></label>
                  <select name="messaging_enabled" id="messaging_enabled" class="form-select" required>
                    <option value="">Seleccione una opción</option>
                    <option value="1" {{ old('messaging_enabled') == '1' ? 'selected' : '' }}>Sí</option>
                    <option value="0" {{ old('messaging_enabled') == '0' ? 'selected' : '' }}>No</option>
                  </select>
                  @error('messaging_enabled')
                    <span class="text-danger small">{{ $message }}</span>
                  @enderror
                </div>
                <div class="mb-3">

...
<head>
    <meta charset="utf-8" />
    <title>500 - Error Interno del Servidor | Sistema de HelpDesk</title>
                ...
                <div class="row">
                    <div class="col-lg-12 text-center pt-4">
                        ...
                        <div class="mt-n4">
                            ...
                            <h3 class="text-uppercase">💥 Ocurrió un error inesperado en el servidor.</h3>
                            <p class="text-muted mb-4">Estamos trabajando para solucionarlo. Intenta nuevamente más tarde.</p>

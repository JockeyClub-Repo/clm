    ...
    <div class="row">
      <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
          <p class="mb-sm-0">Listado De Proveedores</p>
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
              <a href="{{ route('providers.create') }}" class="btn btn-sm btn-primary">Nuevo Registro</a>
...
@push('scripts')
  <script>
   $(document).ready(function () {
    let table = $('#providers-table').DataTable({
      processing: true,
      ...
      columns: [
        ...
        },
        {
          ...
          render: function (data, type, row) {
            let editUrl = `{{ url("providers") }}/${row.id}/edit`;
            return `
